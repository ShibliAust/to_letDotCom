    ...
    <ul>
		...
		?>
		  ...
		  <div class="dropdown-content">
		    ...
		    <a href="http://localhost:8080/admin_contact_us.php">View Contact Us</a>
		  </div>
		  <?php
		}
		?>
				...
				<table class = "container1">
				    ...
				    <?php
						...
						if ($conn->connect_error) {
							...
							$sql = "SELECT Post_ID,Status, Title, Description, Rent, curdate FROM residential_house" ;
							...
							if ($result->num_rows > 0) {
								while($row = $result->fetch_assoc()) {
									...
									<tr>
								      <td><a style="color: #FB667A;" href="detailpost.php?PID=<?php echo $id; ?> & tn=r"><?php echo $a; ?></a></td>
								      <td><?php echo $b; ?></td>
								      <td><?php echo $c; ?></td>
								      <td><?php echo $d; ?></td>
								    </tr>
							...
							$sql = "SELECT Post_ID,Status, Title, Description, Rent, curdate FROM commercial_space" ;
							...
							if ($result->num_rows > 0) {
								while($row = $result->fetch_assoc()) {
									...
									<tr>
								      <td><a style="color: #FB667A;" href="detailpost.php?PID=<?php echo $id; ?> & tn=c"><?php echo $a; ?></a></td>
								      <td><?php echo $b; ?></td>
								      <td><?php echo $c; ?></td>
								      <td><?php echo $d; ?></td>
								    </tr>
