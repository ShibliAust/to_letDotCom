...
<header>
	...
	<?php
			...
			if( isset($_POST['Log_out'] )){
				...
				window.location.href = "http://localhost:1234/Cover_page.php";
				</script> 
				<?php
				exit();
			}
    ...
    <nav>
    <ul>
			<li><a href="http://localhost:1234/subline.php">Home</a></li>
			<li><a href="http://localhost:1234/About_us.php">About Us</a></li>
			<li><a href="http://localhost:1234/Contact_us.php">Contact Us</a></li>
			<li><a href="http://localhost:1234/terms_and_conditions.php">Terms & Conditions</a></li>
		...
		<div class="container">
			...
			<font size="4" color="white">Today's Posts!
				...
				<table class = "container1">
				    ...
				    <?php
						...
						if ($conn->connect_error) {
							...
							$sql = "SELECT Post_ID, Title, Description, Rent, curdate, Status FROM residential_house where curdate = '".$curdate."' " ;
							...
							#klasgggggggggggggggggg


							$sql = "SELECT Post_ID, Title, Description, Rent, curdate, Status FROM commercial_space where curdate = '".$curdate."' " ;
							$result = $conn->query($sql);
							$formid = "form";
							$brr = array(100);
							$cnt = $arrid;
