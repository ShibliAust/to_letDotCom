...
<header>
    ...
    <ul>
		...
		<div class="container">
			...
			<font size="4" color="white">Details!
			...
			<br>
			    ...
			    if(isset($_GET["PID"]) && isset($_GET["tn"]))
			    {
			        $postid = $_GET['PID'];
			        $tn = $_GET['tn'];
					...
					if ($conn->connect_error) {
						...
						if( strcmp($tn, "r" ) == 0){
							$sql = "SELECT Title, catagory, Address, Description, Rent, curdate, Contact_No FROM residential_house where Post_ID = '".$postid."' " ;
						}else{
							$sql = "SELECT Title, catagory, Address, Description, Rent, curdate, Contact_No FROM commercial_space where Post_ID = '".$postid."' " ;
						}
						...
						if ($result->num_rows > 0) {
							while($row = $result->fetch_assoc()) {
								...
								#echo $title . " " . $catagory . " " . $address . " " . $description . " " . $rent . " " . $curdate . " " . $contactno ; 
