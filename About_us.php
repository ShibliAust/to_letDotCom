...
<header>
    ...
    <ul>
		...
		<div class="container">
			...
			<ul id="category_ul">
				<p style="font-size:30px;color:white;text-align:center;">About us</p>
			</ul>
			
			<div id ="writing_box">
			
			<h2 style="padding-top:10px; font-family: verdana; color: DarkSlateGray ; text-align:center; font-size:15px;">
			House rent is tedious with physically observation.
			...
			in the different sections and choose suitable house for rent.
			</h2>
