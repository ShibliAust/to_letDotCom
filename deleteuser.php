...
<header>
    ...
    <ul>
		...
		<div class="container">
			...
			<font size="4" color="white">View All Users
				...
				<table class = "container1">
				    ...
				    <tbody>
						...
						if ($conn->connect_error) {
							...
							$sql = "SELECT name, Email, Phone FROM login" ;
							...
							if ($result->num_rows > 0) {
								while($row = $result->fetch_assoc()) {
										...
										<tr>
									      ...
									      <td><form method = "post" ><input name = <?php echo $formid  ?> type="SUBMIT" value="remove" style="width:100%"></form></td>
									    </tr>
			...
			<?php
				...
				if ($conn->connect_error) {
					...
					for( $i = 0; $i < $arrid; $i++ ){
						...
						if( isset($_POST[$tmp] )){
							#echo  $arr[$i] . "</br>";
							$sql = "DELETE FROM login WHERE Phone = $arr[$i]";
